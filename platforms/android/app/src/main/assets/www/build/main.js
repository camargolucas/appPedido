...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic_native_sqlite_ngx__ = __webpack_require__(354);
...
var DatabaseProvider = /** @class */ (function () {
   ...
   */
    ...
    DatabaseProvider = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__ionic_native_sqlite_ngx__["a" /* SQLite */]])
    ], DatabaseProvider);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilitarios_apiData__ = __webpack_require__(255);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_product_product__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_user_user__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_product_storage_product_storage__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__model_Usuario__ = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angularfire2_auth__ = __webpack_require__(159);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, menu, firebaseAuth, toast, modal, storage, userApi, productProvider) {
        var _this = this;
    ...
    LoginPage.prototype.ngOnInit = function () {
        this.formLogin = new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["b" /* FormGroup */]({
            usuario: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */]("", __WEBPACK_IMPORTED_MODULE_5__angular_forms__["g" /* Validators */].required),
            senha: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */]("", __WEBPACK_IMPORTED_MODULE_5__angular_forms__["g" /* Validators */].required)
        });
    };
    LoginPage.prototype.userData = function (email, password) {
        this.usuario.email = email;
        this.usuario.senha = password;
        this.userApi.getByEmail(this.usuario)
            .then(function (ret) {
            console.log(ret);
        });
    };
    LoginPage.prototype.save = function () {
        return this.productProvider.insert();
    };
    ...
    LoginPage.prototype.loginWithEmail = function () {
        ...
        this.firebaseAuth.auth
            ...
            _this.userData(_this.email.value, _this.password.value);
        })
            .catch(function (erro) {
            _this.showToast(erro);
        });
    };
    ...
    LoginPage.prototype.openSignUp = function () {
        var myModal = this.modal.create(__WEBPACK_IMPORTED_MODULE_4__signup_signup__["a" /* SignupPage */]);
        myModal.present();
    };
    __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__model_Usuario__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_user_user__ = __webpack_require__(158);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edit_product_edit_product__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modal_product_modal_product__ = __webpack_require__(81);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StockPage = /** @class */ (function () {
    function StockPage(navCtrl, navParams, provider, toast, modal, alertCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.provider = provider;
        this.toast = toast;
    ...
    StockPage.prototype.loadData = function (value) {
        ...
        this.provider
            ...
            _this.arrProdutos = results.filter(function (data) {
                return (data.produto.nome["TIPO"] == value && data.produto.categoriaProduto.nomeCategoria == 'Estoque' && data.key !== 'Usuario');
            });
        })
            .catch(function (error) {
            console.log(error);
    ...
    StockPage.prototype.addProduct = function () {
        var _this = this;
        var myModal = this.modal.create(__WEBPACK_IMPORTED_MODULE_4__modal_product_modal_product__["a" /* ModalProductPage */], {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__database_database__ = __webpack_require__(155);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductProvider = /** @class */ (function () {
    ...
    ProductProvider.prototype.insert = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__request_request__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__more_more__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utilitarios_utilitarios__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_contact_contact__ = __webpack_require__(797);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_home_home__ = __webpack_require__(798);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_tabs_tabs__ = __webpack_require__(410);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_storage__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_sqlite_ngx__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__angular_forms__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_ionic2_auto_complete__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__providers_complete_service_complete_service__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__angular_http__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_login_login__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_signup_signup__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_more_more__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27_angularfire2__ = __webpack_require__(799);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28_angularfire2_auth__ = __webpack_require__(159);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__providers_user_user__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__providers_database_database__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__providers_product_product__ = __webpack_require__(353);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_7__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_26__pages_more_more__["a" /* MorePage */],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_21_ionic2_auto_complete__["b" /* AutoCompleteModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_28_angularfire2_auth__["AngularFireAuthModule"]
            ],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_22__providers_complete_service_complete_service__["a" /* CompleteServiceProvider */],
                ...
                __WEBPACK_IMPORTED_MODULE_19__ionic_native_sqlite_ngx__["a" /* SQLite */],
                __WEBPACK_IMPORTED_MODULE_31__providers_product_product__["a" /* ProductProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_ListaProduto__ = __webpack_require__(439);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductStorageProvider = /** @class */ (function () {
    ...
    ProductStorageProvider.prototype.getAll = function () {
        var produtos = [];
        return this.storage
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CategoriaProduto; });
var CategoriaProduto = /** @class */ (function () {
    function CategoriaProduto() {
    }
    return CategoriaProduto;
}());

//# sourceMappingURL=CategoriaProduto.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_tabs_tabs__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_database_database__ = __webpack_require__(155);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilitarios_utilitarios__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilitarios_utilitarios__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__model_Produto__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_CategoriaProduto__ = __webpack_require__(778);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ModalProductPage = /** @class */ (function () {
    function ModalProductPage(navCtrl, navParams, completeService, storage, toast, utilitarios, view) {
        ...
        this.model.categoriaProduto = new __WEBPACK_IMPORTED_MODULE_7__model_CategoriaProduto__["a" /* CategoriaProduto */]();
        this.arrTipo = this.utilitarios.getArrayTipo();
        this.arrUnidade = this.utilitarios.getArrayUnidade();
        // Carrego variaveis com a caategoria do produto para separar Produtos de Estoque e Produtos de Pedido
        var idCategoria = navParams.data["idCategoria"];
        var nomeCategoria = navParams.data["nomeCategoria"];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilitarios_apiData__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(138);
